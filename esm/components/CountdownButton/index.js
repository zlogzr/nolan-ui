...
function CountdownButton(props) {
  var _props$count = props.count,
      num = _props$count === void 0 ? 60 : _props$count,
      _props$title = props.title,
      title = _props$title === void 0 ? '验证码' : _props$title,
  ...
  return /*#__PURE__*/React.createElement(Button, {
    ...
    className: className,
    onClick: handleClick
  }, isRunning ? "".concat(count, "s \u540E\u91CD\u8BD5") : title);
}
